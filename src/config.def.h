...
/* HEDL: the tunables below are not const. hedl.config() writes them and a
 * reload re-applies them to live clients, pointers and the keyboard. */
...
static const Layout layouts[] = {
	...
	{ "[]=",      "tile",     tile },
	{ "><>",      "floating", NULL },  /* no arrange function means floating */
	{ "[M]",      "monocle",  monocle },
};
 ...
 * bind a hedl config writes is on super, so the mouse ought to agree. */
